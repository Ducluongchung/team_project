    ...
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            var client = new SmtpClient
            {
                ...
                Credentials = new NetworkCredential("hanh1997haui@gmail.com", "Hanh1997"),       // Chỉnh email và password gửi đi
                EnableSsl = true,
            };

            var from = new MailAddress("Hanh1997haui@gmail.com", "Admin trang web thương mại điện tử");
